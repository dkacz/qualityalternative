...
Slice 7.4 sharpens the user-facing title and description layer. In particular, `of-studies` ships as `Read to Weigh` in the app while retaining Francis Bacon and `Of Studies` in attribution metadata.
