...
|---|---|---|---|---|---|---:|---|---|---|
| 1 | Start With What Is Yours | `Encheiridion`, opening sections from `A Selection from the Discourses of Epictetus with the Encheiridion` | Epictetus; translated by George Long | https://www.gutenberg.org/ebooks/10661 | Public domain in the U.S.; likely EU/Poland safe after translator check because George Long died in 1879. Remove Project Gutenberg boilerplate before app rendering. | 6-8 min | stoicism, agency, impulse-control | `selected_pending_excerpt_cut` | The first question at the moment of impulse is whether this action is actually in the user's control and interest. |
| 2 | The Morning Test | `Meditations`, Book II selections | Marcus Aurelius; George Long edition to be used if sourced from Standard Ebooks, with Project Gutenberg #2680 as comparison source | https://standardebooks.org/ebooks/marcus-aurelius/meditations/george-long | Standard Ebooks states its produced ebook files are dedicated to the public domain via CC0; underlying Long translation is public-domain candidate after final edition check. | 5-7 min | stoicism, morning, attention, judgment | `selected_pending_excerpt_cut` | A compact reset for the exact moment when the phone becomes a reflex rather than a decision. |
| 3 | The Flywheel of Habit | `The Principles of Psychology`, Chapter IV, `Habit`, selected non-technical passage | William James | https://www.gutenberg.org/ebooks/57628 | Public domain in the U.S.; author died in 1910, so likely EU/Poland safe. Remove Project Gutenberg boilerplate before app rendering. | 8-10 min | habits, psychology, behavior-change | `selected_pending_excerpt_cut` | It explains why small repeated actions become grooves, which directly mirrors the product's habit-interruption thesis. |
| 4 | Live Deliberately | `Walden`, `Where I Lived, and What I Lived For`, selected passage | Henry David Thoreau | https://www.gutenberg.org/files/205/205-h/205-h.htm | Public domain in the U.S.; author died in 1862, so likely EU/Poland safe. Remove Project Gutenberg boilerplate before app rendering. | 7-9 min | deliberate-living, simplicity, values | `selected_pending_excerpt_cut` | It turns "I opened my phone automatically" into the deeper question: what did I mean to do with this minute? |
| 5 | Walk Before You Scroll | `Walking`, opening section from `Excursions` | Henry David Thoreau | https://www.gutenberg.org/ebooks/9846 | Public domain in the U.S.; author died in 1862, so likely EU/Poland safe. Remove Project Gutenberg boilerplate before app rendering. | 8-10 min | nature, movement, attention, decompression | `selected_pending_excerpt_cut` | It gives the user a non-screen alternative frame without making the app feel punitive. |
| 6 | Trust the First Honest Thought | `Self-Reliance`, opening section from `Essays, First Series` | Ralph Waldo Emerson | https://www.gutenberg.org/ebooks/2944 | Public domain in the U.S.; author died in 1882, so likely EU/Poland safe. Remove Project Gutenberg boilerplate before app rendering. | 7-9 min | agency, self-trust, creativity | `selected_pending_excerpt_cut` | It offers confidence and inwardness instead of social comparison. |
| 7 | The Desert Resets the Eye | `The Land of Little Rain`, opening essay selection | Mary Austin | https://www.gutenberg.org/ebooks/10217 | Public domain in the U.S.; author died in 1934, so likely EU/Poland safe. Remove Project Gutenberg boilerplate before app rendering. | 6-8 min | nature-writing, observation, wonder | `selected_pending_excerpt_cut` | Vivid place-writing can pull attention outward without relying on outrage or novelty loops. |
| 8 | Of Studies | `The Essays or Counsels, Civil and Moral`, `Of Studies` | Francis Bacon | https://www.gutenberg.org/files/575/575-h/575-h.htm | Public domain in the U.S.; author died in 1626, so likely EU/Poland safe. Remove Project Gutenberg boilerplate before app rendering. | 4-6 min | learning, judgment, reflection | `selected_pending_excerpt_cut` | A very short, high-density reading for moments when the user will not accept a long replacement. |
...
- [Standard Ebooks and the Public Domain](https://standardebooks.org/about/standard-ebooks-and-the-public-domain): Standard Ebooks dedicates content produced by or for it to the public domain via CC0 1.0.
...
- Project Gutenberg pages checked for selected items: Epictetus #10661, William James #57628, Thoreau #205 and #9846, Emerson #2944, Mary Austin #10217, Francis Bacon #575, and Darwin #944.
