...
- `FR8 Replacement Session Experience`: Markdown and EPUB open in the in-app private reader; PDF uses a clearly labeled Android document-viewer handoff.
...
- Supported import formats:
  ...
  - EPUB: saved as private in-app reader content.
...
- Generic external-handoff analytics for PDF so it is not mislabeled as a user-added web-link fallback event.
...
- Markdown and EPUB documents open in the in-app reader.
- PDF documents open through the external handoff surface and pass URI read permission to Android.
